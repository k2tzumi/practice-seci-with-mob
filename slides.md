...
<!--
モブプログラミングの目的は、全員で学び、知識共有しながら、チーム全体の品質と課題解決力を底上げすることです
-->
...
まず、知識共有の面では、普段人に伝えにくい“暗黙知”がリアルタイムで可視化されて、自然にチームに広がっていきます  
そしてコード品質も上がります  
...
要件を決めるところから運用まで、全部をモブ、つまりチームで一緒にやっちゃおうっていう考え方です  
...
『5人でひとつの作業なんて、効率悪くない？』ってよく言われるんですけど、私はそうじゃないと思っています
...
[click] 一人で悩んで時間がかかりすぎる…みたいな、気づきにくいコストってけっこうありますよね？  
モブワークだと、そういうのを減らせると思ってます
-->
...
登壇者がモブワークを実践している中でとSECIモデルを始めてしった時に「あっ！これかぁ！」となりました。モブワークと凄く親和性が高いと感じました
-->
...
この図の様に時計回りで知識が発展していきます  

以降のスライドでは、SECIモデルの4つのプロセスの説明と合わせて、登壇者が意識的に取り組んできたモブワークの実践内容を織り交ぜながら説明をしていきます

その中で『〇〇モード』という言葉がたくさん出てきますが、
これは『その時々の状況に応じて、モブワークのやり方を使い分ける』という意味だと思ってください
...
以下の様なモードを切り替えながらやるのが良いです

まず雑談・交流促進モードで信頼関係構築します  
[click] ローテーション・体験共有モードで多様な視点体験  
[click] 世代交代・継承モードで教わる側・教える側の両方を経験して知識継承していきます  

経験者の動きを観察して暗黙知に触れて、自分もドライバーとして体験することができてることがモブワークの良い所です
-->
...
まず「感じて」真似ることから始まるという所を意識すると良いです
-->
...
<!--
2つ目の表出化は暗黙知を言語化するプロセスです

「なんとなくこうした方がいい」を「なぜなら、こうなっており、こうあるべき」に変換します  
ドキュメント化や議論がこれにあたります
-->
