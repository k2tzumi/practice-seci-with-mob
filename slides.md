...
<!--
今日は、PHPのコードの話は出てきません。  
技術そのものではなく、チームでどう知識を育てていくかを話します。  
本セッションは、モブワークに興味がある方や、複雑な問題をチームでどう解決しようか？悩んでいる方に向けに話します。
-->
...
<!--
それでは、本日のテーマである「モブワーク」とは何か、という話から始めましょう。
-->
...
<!--
モブワークは聞き馴染みはなくてもモブプログラミングはご存知なのではないでしょうか？
-->
...
Woody Zuill氏が始めた手法で、ペアプロを全員参加型にしたものになります
-->
...
役割分担はシンプルで  
ドライバー：キーボードを叩く人（1人）  
ナビゲーター：「何をするか」を考えてドライバーに指示をだす人（その他全員）  
15〜30分程度で役割を入れ替えていきます
-->
...
<!--
モブロの目的は、全員で学び、共有しながら、チーム全体の力を底上げすることです。
-->
...
<!--
一番の理由は「知識の共有」です  
普段、一人で考えて一人で実装してることを、みんなでやる  
そうすると、個人が持ってる「コツ」や「判断基準」がリアルタイムで共有されます  

(click)  

あと、品質も上がるし、属人化も防げるし、新人も自然に育ちます
...
モブプログラミングは「コード書くこと」に特化  
モブワークは「あらゆる仕事」に適用できる概念です  
要件定義から運用まで、なんでもモブでやっちゃおうというものです  
...
みんなで一つの問題に立ち向かう感覚になります

(click)  

複数の視点を活かして問題を解決し、暗黙知をリアルタイムでチームに共有することができます
-->
...
<!--
野中郁次郎さんが提唱した「知識がどうやって生まれるか」の理論です  
ポイントは「暗黙知」と「形式知」の変換です
-->
...
既存の知識を組み合わせて新しい知識を作る  
データを分析したり、システムを設計したり
-->
...
この4つが回り続けることで、組織の知識がどんどん成長していく  
これが「知識スパイラル」と呼ばれるものです
-->
