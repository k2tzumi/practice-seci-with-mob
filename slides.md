...
<!--
ここから本セッションの肝となる、SECIモデルの話になります
-->
...
<!--
野中郁次郎さんが提唱した理論で、「どうやって個人の知識がチーム全体の力になるか」を説明したものです
...
(click)  
ローテーション・体験共有モードで多様な視点体験  
(click)  
世代交代・継承モードで教わる側・教える側双方にメリットがあります。
...
リアルタイム言語化モードでドライバーの思考を声に出す。これ、最初は恥ずかしいんですが、慣れるとすごく学習効果が高いです

(click)

エキスパート活用モードでは、初心者の素朴な質問を活用します。教える側にとっても学びがあり、改善にも繋がります
-->
...
リアルタイム統合・コラボレーションモードで異なる専門分野の知識をその場で組み合わせる
...
他の人と一緒に考えることで、学習が加速されます  
心理学でいう「最近接発達領域」がチーム全体で実現される感じです

(click)

モブで「あーじゃない。こーじゃない」の議論をする中で新しい発見があるとすごくチーム全体の成長を感じます   
