...
<!--
簡単に言うと、「みんなで一つのパソコンを使って開発する」やり方です  
...
複数の視点を活かして問題を解決し、暗黙知をリアルタイムでチームに共有ができます
-->
...
<!--
SECIモデルには4つのプロセス（共同化、表出化、連結化、内面化）があます  
この図では時計回りに知識が発展します  
では1つずつ見ていきましょう。
-->
